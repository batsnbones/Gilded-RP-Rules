...
- **Restricted Items** Any items that represent hate-based groups (such as KKK hoods), nudist/inappropriate attire, and extreme immersion-breaking items are prohibited. Other restricted pieces require staff approval via a ticket for specific use.
